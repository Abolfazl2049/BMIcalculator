 ...
 return document.getElementById("p2").innerHTML= result;
  ...
  if (Gender1 == 1) {
      if (age >= 1 && age <= 3) {
        ...
        result+= '.' + "<br>" + 'youre baby is fit.';
        return  document.getElementById("p2").innerHTML= result;
        }else if (result <= 16 ){
        result += "." + '<br>' + 'youre babie is too skinny. try to give him more food.' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 21){
        result += '.' + '<br>' + 'youre babie is  getting fat.i suggest you to give him less.(food)';
        return document.getElementById("p2").innerHTML= result;
  }
        ...
        return  document.getElementById("p2").innerHTML= result;
         ...
         result += "." + '<br>' + 'youre  too skinny kiddo. try to eat more food.you are in an important age' + '<br>' + 'if u can';
         return document.getElementById("p2").innerHTML= result;
        }else if (result >= 22){
        result += '.' + '<br>' + 'youre getting fat.i suggest you to eat less.(food)';
        return document.getElementById("p2").innerHTML= result;
        ...
        result += "." + '<br>' + 'youre  too skinny . try to eat more food.you are in an important age' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 24){
        result += '.' + '<br>' + 'youre getting fat.i suggest you to eat less mister.(food)';
        return document.getElementById("p2").innerHTML= result;
        ...
        result += "." + '<br>' + 'youre  too skinny mister.try to eat more food.' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 26){
        result += '.' + '<br>' + 'youre getting fat.i suggest you to eat less.(food)';
        return document.getElementById("p2").innerHTML= result;
        ...
        result += "." + '<br>' + 'youre  too skinny old man. try to eat more food.you are in a dangerous age' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 23){
        result += '.' + '<br>' + 'youre getting fat .i suggest you to eat less.(food)';
        return document.getElementById("p2").innerHTML= result;
      ...
      if (age >= 1 && age <= 3) {
        ...
        result += "." + '<br>' + 'youre  too skinny mam.try to eat more food.' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 26){
        result += '.' + '<br>' + 'youre getting fat.i suggest you to eat less.(food)';
        return document.getElementById("p2").innerHTML= result;
        ...
        result += "." + '<br>' + 'youre  too skinny granny. try to eat more food.you are in a dangerous age' + '<br>' + 'if u can';
        return document.getElementById("p2").innerHTML= result;
        }else if (result >= 23){
        result += '.' + '<br>' + 'youre getting fat .i suggest you to eat less.(food)';
        return document.getElementById("p2").innerHTML= result;
